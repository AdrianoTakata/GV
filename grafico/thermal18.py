...
path4 = '../SB/dx202/unsteady/%s/fgv09/tt155520/' %(lambda_z)
path5 = '../SB/dx202/unsteady/%s/fgv12/tt155520/' %(lambda_z)
path6 = '../SB/dx202/unsteady/%s/fgv15/tt155520/' %(lambda_z)
...
x2, dthmdy2 = pos_thermal(path2, 1065)

x3, dthmdy3 = pos_thermal(path3, 1065)

x4, dthmdy4 = pos_thermal(path4, 1065)

x5, dthmdy5 = pos_thermal(path5, 1065)

x6, dthmdy6 = pos_thermal(path6, 1065)
