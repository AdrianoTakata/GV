!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!      
      ...
      implicit none
      include '../SB/dx202/unsteady/lam18/fgv06/tt207360/par.for'
     ...
     &'../SB/dx202/unsteady/lam18/fgv06/tt207360/isoq_',perd,'.bin'
        open(unit=8, FILE=path1, form='unformatted')
        read(8) Q
        close(unit=8)

        write(path2, '(a,i0.2,a)')
     &'../SB/dx202/unsteady/lam18/fgv06/tt207360/spatial_',perd,'.bin'
        ...
        write(nome, '(a,i0.2,a)')'lam18_fgv06_perd',perd,'.vtk'
