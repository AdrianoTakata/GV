!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!      
      ...
      implicit none
      include '../SB2/dx202/unsteady/lam36/fgv12/tt103680/par.for'
     ...
     &'../SB2/dx202/unsteady/lam36/fgv12/tt103680/isoq_',perd,'.bin'
        open(unit=8, FILE=path1, form='unformatted')
        read(8) Q
        close(unit=8)

        write(path2, '(a,i0.2,a)')
     &'../SB2/dx202/unsteady/lam36/fgv12/tt103680/spatial_',perd,'.bin'
        ...
        write(nome, '(a,i0.2,a)')'lam36_fgv12_perd',perd,'.vtk'
