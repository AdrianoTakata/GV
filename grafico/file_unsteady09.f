!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!      
      ...
      implicit none
      include '../SB/dx202/unsteady/lam09/fgv15/tt103680/par.for'
     ...
     &'../SB/dx202/unsteady/lam09/fgv15/tt103680/isoq_',perd,'.bin'
        open(unit=8, FILE=path1, form='unformatted')
        read(8) Q
        close(unit=8)

        write(path2, '(a,i0.2,a)')
     &'../SB/dx202/unsteady/lam09/fgv15/tt103680/spatial_',perd,'.bin'
        ...
        write(nome, '(a,i0.2,a)')'lam09_fgv15_perd',perd,'.vtk'
