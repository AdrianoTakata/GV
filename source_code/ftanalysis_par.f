...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      parameter ( N = 16, MM = 4 )
      real*8 a(N), b(N), A1x(imax/8+1,jmax,N), yy, x(3), y(3), cof(3),
     &       ymax, kk, xad, amaxx(imax/8+1,N), amax(imax/8+1,N),
     &       alfaux(imax/8+1,N)
      complex*16 ux_f(imax/8+1,jmax,kfour,N)
...
c     Calculating the amplitudes
        ...
        do f = 1, N / 2
          ...
          write(1,*) 'ZONE T="',nome2,'", I=',imax / 8 - 3
          do i = 1, imax / 8 + 1
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      complex*16 ux(ptsx/8+1,jmax,kfour), 
     &           ux_f(imax/8+1,jmax,kfour,N)

      do my_rank = 0, np - 1
        shift = my_rank * ((ptsx-1)/ 8 - inter / 8)
        do f = 1, N
          write(nm,'(a,i0.2,a,i0.2,a)')'pert_',my_rank,'_',f,'.bin'
