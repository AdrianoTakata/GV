...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     &                             + duydzp(i,j,k) * duzdyp(i,j,k) ) )
        ...
        call escreveq(Q, cont)
        if (fhz_gv .eq. 0.0d0) stop
      end do
      end

cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc

      subroutine initval(cont)

      implicit none
      include 'par.for'
      include 'comm.coef'
      character*30 nome
      integer i, j, t, my_rank, k, shift, cont
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      write(nome, '(a,i0.2,a)')'isoq_',cont,'.bin'
